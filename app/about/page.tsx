    ...
    <section className="w-full bg-slate-100 dark:bg-slate-800">
      <div className="container h-auto md:h-[calc(100dvh-101px)] flex items-center justify-center">
        <div className="max-w-5xl 2xl:max-w-7xl mx-auto">
          <div className="w-full bg-gray-transparent md:bg-white py-5 md:p-5 flex md:flex-row flex-col xl:rounded-md md:shadow-md">
            <div className="flex-1 flex flex-col justify-center space-y-1 md:space-y-4 pr-3 pb-5">
              <h1 className="text-xl tracking-wider md:text-3xl text-gray-600 font-bold">
                Bit about myself
              </h1>
